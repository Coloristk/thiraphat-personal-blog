...
function NavBar(){
  return(
    <nav className='bg-[#F9F8F6] w-full h-20 py-3 px-6 border-b border-solid border-[#DAD6D1] flex items-center md:flex justify-between md:py-4 md:px-32'>
      <a href="" className='text-2xl font-bold'>hh<span className='text-green-500'>.</span></a>
...
function HeroSection(){
  return(
    <main className='px-4 py-10 md:py-16 mx-auto'>
      <div className='flex flex-col items-center md:flex-row md:items-center md:gap-14'>
        <div className='md:w-1/3 mb-8 md:mb-0 md:pr-8'>
          <h1 className='text-4xl text-[#26231E] text-center md:text-6xl md:text-right font-bold mb-4'>
        ...
        <img src="https://res.cloudinary.com/dcbpjtd1r/image/upload/v1728449784/my-blog-post/xgfy0xnvyemkklcqodkg.jpg" alt="Man with a cat" 
        ...
        <div className='md:w-1/3 mb-8 md:mb-0 md:pr-8'>
          ...
          <h2 className='text-2xl text-[#26231E] font-bold mb-4'>Thompson P.</h2>
